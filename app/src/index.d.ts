...
declare namespace Neutralino {
  ...
  type AppMode = "window" | "browser" | "cloud";
  ...
  namespace settings {
    function getSettings(
      success: (data: SettingsData) => void,
      fail: () => void
    ): void;
  }
  ...
  namespace filesystem {
    ...
    function readDirectory(
      dirName: string,
      success: (data: DirectoryData) => void,
      fail: () => void
    ): void;
    function writeFile(
      filename: string,
  ...
  namespace debug {
    function log(
      logType: LogType,
      message: string,
      success: (data: LogSuccessData) => void,
      fail: () => void
    ): void;
  }
